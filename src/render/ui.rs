...
pub fn draw_ui(
    ...
    match res.phase {
        GamePhase::Active => {
            draw_text(&format!("Level: {}", res.progress.current_level), res.display.width as i32 - 250, 10, false);
        ...
        GamePhase::GameOver => {
            ...
            draw_text(&format!("Highest Level: {} On {}", res.progress.highest_level, res.timer.timer_text), cx, cy, true);
